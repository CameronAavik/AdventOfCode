...
public class Y2024Tests
{
    ...
    [TestMethod][MultiInputData(2024, 7)] public void Day07(string filePath, string expectedPart1, string expectedPart2) => TestHelpers.AssertDay<Day07>(filePath, expectedPart1, expectedPart2);
}
